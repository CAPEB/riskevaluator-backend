...
public interface QuestionRepository extends JpaRepository<QuestionEntity, Integer> {
    ...
    List<CategorieQuestionEntity> getCategorieQuestionsByQuestionnaireIdAndMetiers(@Param("aQuestionnaireId") Integer aQuestionnaireId, @Param("metierIds") Set<Integer> metierIds);
